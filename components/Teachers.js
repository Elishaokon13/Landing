    ...
    <div className="container bg-[#000000] mx-auto py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-16 py-10 lg:py-20">
        <div className="flex flex-col gap-5 ">
          ...
          <p className="text-2xl font-semibold text-[#ffffff]">Abimbola Abe</p>
          <div className="flex items-center gap-2">
            <img src="/assets/FE.jpg" alt="itersfgjds" className="rounded-xl"/>
          </div>
          <p className="text-2xl font-semibold text-[#ffffff]" >Favour Ezeh</p>

        </div>
        <div className="flex flex-col gap-5 ">
          <img src="/assets/MEZ.jpg" alt="v1" className="rounded-xl"/>
          <p className="text-2xl font-semibold text-[#ffffff]">Mezie TheSage</p>
          <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col gap-5 ">
          ...
          <p className="text-2xl font-semibold text-[#ffffff]">Leader Bill</p>
          <div className="flex items-center gap-2">
