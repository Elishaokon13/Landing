  ...
  return (
    <div className="container mx-auto py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-16 py-20">
        ...
        <div className="flex flex-col gap-5 items-center">
          <img src="/assets/teddy.png" alt="v1" className="w-20"/>
        ...
        <div className="flex flex-col gap-5 items-center">
          <img src="/assets/leader.png" alt="v1" className="w-20"/>
        ...
        <div className="flex flex-col gap-5 items-center">
          <img src="/assets/gear.png" alt="v1" className="w-20"/>
        ...
        <div className="flex flex-col gap-5 items-center">
          <img src="/assets/mezie.png" alt="v1" className="w-20"/>
      ...
      <div className="grid grid-cols-1 justify-center sm:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-16 py-50">
          <div className="flex flex-col gap-5 items-center">
            <img src="/assets/munachimso.png" alt="v1" className="w-20"/>
          ...
          <div className="flex flex-col gap-5 items-center">
            <img src="/assets/abimbola abe.png" alt="v1" className="w-20"/>
